...
add_library(ludash-render-core src/render_core/GLDispatch.c src/render_core/ShaderProgram.c src/render_core/WallpaperPass.c src/render_core/BlurPass.c)
...
target_compile_definitions(ludash-update-check PRIVATE LUNADASH_VERSION="${PROJECT_VERSION}" LUNADASH_GIT_COMMIT="${LUNADASH_GIT_COMMIT}")
...
add_library(ludash-apps src/theme/DesktopTheme.cpp src/application_catalog/ApplicationCatalog.cpp src/application_window/ApplicationWindow.cpp src/file_manager/FileManager.cpp src/file_icons/FileIcons.cpp src/file_icons/FileIconDelegate.cpp src/console/Console.cpp src/system_monitor/SystemMonitor.cpp src/welcome/Welcome.cpp src/launcher/Launcher.cpp src/packages/PackageManager.cpp src/plugin_settings/PluginSettings.cpp)
...
add_library(ludash-wayland src/compositor/WaylandCompositor.cpp src/compositor_extensions/ProtocolExtensions.cpp src/window_frame/WindowFrame.cpp src/input_method/InputMethodSupport.cpp src/layer_shell/LayerShell.cpp src/layer_shell/LayerSurface.cpp src/screen_capture/ScreenCapture.cpp src/screen_capture/ScreenCaptureFrame.cpp src/ipc/ControlServer.cpp src/system_status/SystemStatus.cpp src/compositor/ResizeGuideItem.cpp src/compositor/LuDashUtils.cpp ${LAYER_HEADER} ${LAYER_CODE} ${SCREENCOPY_HEADER} ${SCREENCOPY_CODE})
