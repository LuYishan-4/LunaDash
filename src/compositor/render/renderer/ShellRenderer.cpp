#include "compositor/render/renderer/ShellRenderer.hpp"
namespace LuDash {
bool configureShellRendering(QProcessEnvironment& environment, bool nvidiaDriver) {
    ...
    if (requested != "auto" && requested != "opengl" && requested != "software") return false;
    ...
    const bool software = requested == "software" || (requested == "auto" && nvidiaDriver);
