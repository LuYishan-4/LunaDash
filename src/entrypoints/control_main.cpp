...
int main(int argc, char** argv) {
    ...
    if (args.size() < 2) { QTextStream(stderr) << "Usage: ludashctl status|workspace|focus|minimize|close|language|wallpaper|wallpaper-image|wallpaper-default|appearance|setup|finish-setup|configure-network|launch-x11|open-settings|system-tool|audio|power-profile|desktop-size|reset-preferences|default-apps|launch-default|module-validate|module-save|module-template|module-code-trust|module-reset|quit [value]\n"; return 2; }
