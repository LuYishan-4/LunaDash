...
public:
  ...
  QString applicationForFile(const QString &path,
                             QString *error = nullptr) const;
  bool setPreferences(bool initialized, bool askOnFirstOpen,
                      QString *error = nullptr) const;
  bool setRule(const QString &key, const QString &desktopId,
               const QString &mimeType, QString *error = nullptr) const;
