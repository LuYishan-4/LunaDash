...
QWidget *createFileManager() {
  ...
  auto *forward =
      button(FileIcon::Forward, translate("Forward"), "fileForward");
  ...
  auto *hidden =
      button(FileIcon::Eye, translate("Show hidden files"), "fileHidden");
  ...
  addButton(FileIcon::Terminal, translate("Open terminal here"),
            "fileTerminal");
  ...
  auto *previewHint =
      new QLabel(translate("Images preview directly. Video thumbnails use "
