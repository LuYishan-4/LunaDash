...
QLineEdit, QPlainTextEdit, QTreeView, QListWidget { background: #141c26; border: 1px solid #405f62; border-radius: 7px; padding: 9px; selection-background-color: #436185; }
