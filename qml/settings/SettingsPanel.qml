...
ModuleSurface {
    ...
    ColumnLayout {
        ...
        RowLayout {
            SettingsComponents.PageTitle { shell: settings.shell; title: "Settings"; color: moduleForeground; font.pixelSize: 26; Layout.fillWidth: true }
            Text { text: "LuDash"; color: moduleAccent; font.pixelSize: 14 }
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                TextField {
                    id: search; Layout.fillWidth: true; placeholderText: shell.tr("Search settings"); placeholderTextColor: Theme.muted
