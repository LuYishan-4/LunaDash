...
ColumnLayout {
    ...
    HelpText { shell: page.shell; message: "Idle suspend, lid actions, backlight control and automatic screen locking are not managed by LuDash yet. In nested sessions, keep using your host desktop's power settings." }
