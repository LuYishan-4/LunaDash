...
ColumnLayout {
    ...
    HelpText { shell: page.shell; message: "Idle suspend, lid actions and automatic screen locking are not managed by LunaDash yet. In nested sessions, keep using your host desktop's power settings." }
}
