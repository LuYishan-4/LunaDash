...
ColumnLayout {
    ...
    ShellButton { text: shell.tr("Plugin settings"); onClicked: shell.command("open-settings", "plugins") }
    ...
    HelpText { shell: page.shell; message: "LunaDash does not provide a secure lock screen, a notification service, screen-reader integration or portal permission management yet. Use the host desktop for these features while testing nested sessions." }
