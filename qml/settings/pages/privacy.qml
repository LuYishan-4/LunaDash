...
ColumnLayout {
    ...
    HelpText { shell: page.shell; message: "LuDash does not provide a secure lock screen, a notification service, screen-reader integration or portal permission management yet. Use the host desktop for these features while testing nested sessions." }
