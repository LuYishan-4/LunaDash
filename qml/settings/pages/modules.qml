...
ColumnLayout {
    ...
    SettingsCard {
        ...
        RowLayout {
            Layout.fillWidth: true
            Text { text: shell.tr("Schema version"); color: Theme.muted; font.family: Theme.font; Layout.fillWidth: true }
            Text { text: String(page.visualDocument.schemaVersion ?? 1); color: Theme.text; font.family: Theme.font }
        }
        RowLayout {
            Layout.fillWidth: true
    ...
    SettingsCard {
        ...
        RowLayout {
            Layout.fillWidth: true
            Text { text: shell.tr("Automatic width"); color: Theme.text; font.family: Theme.font; Layout.fillWidth: true }
            SoftSwitch {
        ...
        RowLayout {
            Layout.fillWidth: true
            Text { text: shell.tr("Automatic height"); color: Theme.text; font.family: Theme.font; Layout.fillWidth: true }
            SoftSwitch {
    ...
    SettingsCard {
        ...
        RowLayout {
            Layout.fillWidth: true
            Text { text: shell.tr("Accent glow"); color: Theme.text; font.family: Theme.font; Layout.fillWidth: true }
            SoftSwitch { checked: page.config.glow ?? true; onToggled: page.setConfig("glow", checked) }
        }
        RowLayout {
            Layout.fillWidth: true
            Text { text: shell.tr("Orbit ring"); color: Theme.text; font.family: Theme.font; Layout.fillWidth: true }
            SoftSwitch { checked: page.config.orbit ?? true; onToggled: page.setConfig("orbit", checked) }
        }
    }
    ...
    SettingsCard {
        ...
        RowLayout {
            Layout.fillWidth: true
            Text { text: shell.tr("Use custom QML"); color: Theme.text; font.family: Theme.font; Layout.fillWidth: true }
            SoftSwitch { checked: page.custom.enabled ?? false; onToggled: page.setCustom("enabled", checked) }
        }
        RowLayout {
            Layout.fillWidth: true
    ...
    SettingsCard {
        ...
        ScrollView {
            ...
            TextArea {
                ...
                background: Rectangle { color: Theme.surface; radius: 12; border.width: 1; border.color: Theme.border }
            }
        }
        RowLayout {
            ShellButton { text: shell.tr("Validate JSON"); onClicked: shell.command("module-validate", editor.text) }
            ShellButton { text: shell.tr("Save JSON"); active: true; enabled: page.dirty && !page.saving; onClicked: page.saveDocument() }
        }
    }
