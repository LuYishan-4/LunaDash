...
ColumnLayout {
    ...
    HelpText { shell: page.shell; message: "The taskbar lists windows from every workspace. Selecting one switches to its workspace with an animation and enlarges it while keeping the other rows visible." }
    ...
    HelpText { shell: page.shell; message: "Super + 1–9 switches workspaces; Super + 0 selects workspace 10. Add Shift to move a window. Super + H / L focuses columns; Super + J / K focuses rows. Super + F maximizes or restores the column width." }
