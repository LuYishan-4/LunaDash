...
Item {
    ...
    readonly property var paths: ({
        ...
        github: "M12 3 A9 9 0 0 0 9 20 C9 18 9 17 8 16 C5 16 4 14 4 14 C4 13 5 13 6 14 C7 15 9 15 10 14 C7 13 6 11 6 9 C6 7 7 6 8 5 C8 5 10 6 12 6 C14 6 16 5 16 5 C17 6 18 7 18 9 C18 11 17 13 14 14 C15 15 15 17 15 20 A9 9 0 0 0 12 3",
