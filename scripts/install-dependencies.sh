...
case "$manager" in
    ...
    emerge)
        run "${elevate[@]}" emerge --noreplace \
            ...
            sys-apps/xdg-desktop-portal sys-apps/xdg-desktop-portal-gtk gui-apps/grim gui-apps/slurp app-misc/brightnessctl app-misc/ddcutil x11-misc/shared-mime-info app-shells/fish x11-terms/kitty \
